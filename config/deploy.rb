...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/acaidagruta.git" 
# set :scm, :subversion
...
set :local_path, "/Users/Allan/Sites/acaidagruta"
...
set :local_domain, 'acaidagruta.art.com.br' #FIXME
